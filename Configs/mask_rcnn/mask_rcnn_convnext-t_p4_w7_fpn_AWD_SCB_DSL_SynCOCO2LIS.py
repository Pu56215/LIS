...
data_root = '/root/workspace/LIS/dataset/coco/'
...
test_lod_coco = dict(
    ...
    type='CocoDataset',
    ann_file='/root/workspace/LIS/dataset/coco/annotations/lis_coco_png_test+1.json',
...
coco = dict(
    ...
    type='CocoDataset',
    ann_file='/root/workspace/LIS/dataset/coco/annotations/lis_coco_png_train.json',
    # seg_prefix='/data3/chenlinwei/dataset/coco/stuffthingmaps/train2017/',
    img_prefix='/root/workspace/LIS/dataset/RGB-normal',
    pipeline=train_pipeline)

coco_val = dict(
    classes=('bicycle', 'chair', 'dining table', 'bottle', 'motorcycle', 'car', 'tv', 'bus'),
    type='CocoDataset',
    ann_file='/root/workspace/LIS/dataset/coco/annotations/lis_coco_png_test.json',
    img_prefix='/root/workspace/LIS/dataset/coco/val2017/',
    pipeline=test_pipeline)
